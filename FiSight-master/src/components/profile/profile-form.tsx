          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid sm:grid-cols-2 gap-4">
                ...
                render={({ field }) => (
                    ...
                    <FormControl>
                        <Input type="number" placeholder="40,000" {...field} />
                    </FormControl>
                    <FormMessage />
                    </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="e.g., Savings Account: ₹25,00,000, Investment Portfolio: ₹10,25,000" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
             ...
             <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="e.g., Credit Card Debt: ₹2,00,000, Student Loans: ₹15,00,000" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
