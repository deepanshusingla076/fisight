          ...
          <nav className="flex items-center gap-6 text-sm font-medium">
            {navLinks.map((link, index) => (
              <motion.div
                ...
                whileHover={{ y: -2 }}
              >
                <Link href={link.href as any} className="text-muted-foreground transition-colors hover:text-foreground">
                  {link.label}
                </Link>
              </motion.div>
            ))}
            ...
            <SheetContent side="right">
              <div className="grid gap-6 p-6">
                ...
                <nav className="grid gap-4">
                  {navLinks.map(link => (
                    <Link key={link.href} href={link.href as any} className="text-muted-foreground transition-colors hover:text-foreground">
                      {link.label}
                    </Link>
                  ))}
                </nav>
