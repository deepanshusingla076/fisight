              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="e.g., 'What if I invest ₹10,00,000 into a high-growth tech stock index fund and hold it for 5 years?' or 'What is the impact of taking a year off work to travel?'"
